...
/**
 * PropertyList component - Displays properties using Material React Table with RTL support.
 * 
 * Features:
 ...
 * - Column reordering (drag and drop) - ENABLED by default in MRT
 * - Hebrew RTL layout
  ...
  return (
    <Box sx={{ direction: 'rtl' }}>
      ...
      <MaterialReactTable
        columns={columns}
        data={displayData}
        enableColumnOrdering // Enable column reordering
        enableColumnResizing
        enableStickyHeader
        enableRowActions
        positionActionsColumn="first" // Actions on right in RTL
      ...
      <Dialog open={openForm} onClose={() => setOpenForm(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedProperty ? 'עריכת נכס' : 'נכס חדש'}
        </DialogTitle>
        <DialogContent>
          <PropertyForm
